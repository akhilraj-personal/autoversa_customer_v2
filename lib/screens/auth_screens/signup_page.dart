...
class SignupPageState extends State<SignupPage> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        bool shouldAllowBackNavigation =
            await _showExitConfirmationDialog(context);
        return shouldAllowBackNavigation;
      },
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 20),
                            Text(
                              lang.S.of(context).register_new_account,
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Text(
          ...
          style: montserratMedium.copyWith(fontSize: 16, color: blackColor),
        ),
        actions: [
          TextButton(
            onPressed: () {
