                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            style:
                                                                                montserratRegular.copyWith(color: blackColor, fontSize: width * 0.037),
                                                                          ),
                                                                        ),
                                                                        ...
                                                                        Container(
                                                                            margin:
                                                                                EdgeInsets.only(top: height * 0.007, bottom: height * 0.007),
                                                                            child: RichText(
                                                                              text: TextSpan(
                                                                                text: "Date: ",
                                                                                style: montserratSemiBold.copyWith(color: blackColor, fontSize: width * 0.034),
                                                                                children: <TextSpan>[
                                                                                  TextSpan(text: bookingList[index]['bk_booking_date'] != null ? DateFormat('dd-MM-yyyy').format(DateTime.tryParse(bookingList[index]['bk_booking_date'])!) : "", style: montserratRegular.copyWith(color: blackColor, fontSize: width * 0.034)),
                                                                                ],
                                                                              ),
                                                                            )),
                                                                        ...
                                                                        RichText(
                                                                          text:
                                                                            ...
                                                                            text:
                                                                                "Time: ",
                                                                            style:
                                                                                montserratSemiBold.copyWith(color: blackColor, fontSize: width * 0.034),
                                                                            children: <TextSpan>[
                                                                              TextSpan(text: bookingList[index]['tm_start_time'] != null ? timeFormatter(bookingList[index]['tm_start_time']) + " - " + timeFormatter(bookingList[index]['tm_end_time']) : "", style: montserratRegular.copyWith(color: blackColor, fontSize: width * 0.034)),
                                                                            ],
                                                                          ),
                                                                        ),
