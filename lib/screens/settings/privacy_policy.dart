        ...
        body: Container(
          ...
          child: ListView(
            children: [
              ...
              RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                        text: "● Account ",
                        style: montserratSemiBold.copyWith(fontSize: 16)),
                    TextSpan(
                        text:
              ...
              RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(
                        text:
                            "refers to Autoversa, the software program provided by the Company."),
                  ],
                ),
              ),
              SizedBox(height: 8),
              RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(
                        text:
                            "(referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Autoversa Auto Repairs, Musaffah – M-33 – Abu Dhabi"),
                  ],
                ),
              ),
              SizedBox(height: 8),
                ...
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                        text: "● Country ",
                        style: montserratSemiBold.copyWith(fontSize: 16)),
                    TextSpan(text: "refers to: United Arab Emirates"),
                  ],
                ),
              ),
              SizedBox(height: 8),
                ...
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                        text: "● Website ",
                        style: montserratSemiBold.copyWith(fontSize: 16)),
                    TextSpan(text: "refers to Autoversa, accessible from "),
                    TextSpan(
                        text: " https://benzuae.com/",
                        style: montserratSemiBold.copyWith(fontSize: 16)),
                  ],
                ),
              ),
              ...
              SizedBox(height: 8),
              Text(
                "Our site may integrate with third-party platforms for better functionality. While these integrations may not directly share your Personal Information, they help in enhancing your browsing experience and our service delivery.",
                style: montserratRegular.copyWith(fontSize: 16),
                textAlign: TextAlign.justify,
              ),
              SizedBox(height: 8),
              ...
              RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                        text: "● Necessary / Essential Cookies Type",
                        style: montserratSemiBold.copyWith(fontSize: 16)),
                    TextSpan(
                        text:
              ...
              RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                        text: "● Functionality Cookies Type:",
                        style: montserratSemiBold.copyWith(fontSize: 16)),
                    TextSpan(
                        text:
