...
class TryOutFlow extends StatefulWidget {
  final String bk_id;
  ...
  @override
  State<TryOutFlow> createState() => TryOutFlowState();
}

class TryOutFlowState extends State<TryOutFlow> {
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          if (Platform
                                                                            ...
                                                                            final Uri
                                                                                url =
                                                                                Uri(scheme: 'tel', path: SAphoneNumber);
                                                                            if (await canLaunchUrl(url)) {
                                                                              await launchUrl(url);
                                                                            }
                                                                          }
